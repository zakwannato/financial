...
<div class="card card-custom">
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        ...
        <div class="card-toolbar">
            <!--begin::Button-->
            <a href="{{ route('commitments.index') }}" class="btn btn-primary font-weight-bolder float-right">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('commitments.update', $commitments->id) }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label>User :</label>
                    <select class="form-control" name="user_id_pay" required>
                ...
                <div class="form-group">
                    <label>Date :</label>
                    <input class="form-control" type="date" name="com_pay_date"/>
                </div>
                ...
                <div class="form-group">
                    <label>Remarks :</label>
                    <textarea class="form-control" name="com_remarks" rows="3"></textarea>
                </div>
