						...
						<div class="login-signin">
							...
							<form class="form"  method="POST" action="{{ route('login') }}">
								...
								<div class="form-group">
									<input class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8 mb-5" type="email" placeholder="Email" name="email" autocomplete="off" id="email" :value="old('email')" />
								</div>
								<div class="form-group">
