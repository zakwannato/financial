    ...
    <div class="card card-custom gutter-b" >
        <div class="card-body form-group  row">
            <div class="col-lg-3" >
                ...
                <input class="form-control" type="month" wire:model.change="yearMonth" />							
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-header border-0">
                    <h3 class="card-title font-weight-bolder text-dark">Shared</h3>
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="d-flex align-items-center mb-9 bg-light-warning rounded p-5">
                        ...
                        <div class="d-flex flex-column flex-grow-1 mr-2">
                            <a href="#" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Total Amount</a>
                            <span class="font-weight-bolder text-warning py-1 font-size-lg">+{{ $totalRecords }}%</span>
                        </div>
                        <!--end::Title-->
                    </div>
                    <!--end::Item-->
        ...
        <div class="col-lg-4">
            ...
            <div class="card card-custom card-stretch gutter-b">
                <!--begin::Header-->
                <div class="card-header border-0">
                    <h3 class="card-title font-weight-bolder text-dark">Advance</h3>
                    <div class="card-toolbar">
                        <div class="dropdown dropdown-inline" data-toggle="tooltip" title="Quick actions" data-placement="left">
                            <a href="#" class="btn btn-clean btn-hover-light-primary btn-sm btn-icon" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="ki ki-bold-more-ver"></i>
        ...
        <div class="col-lg-4">
            ...
            <div class="card card-custom card-stretch gutter-b">
                <!--begin::Header-->
                <div class="card-header border-0">
                    <h3 class="card-title font-weight-bolder text-dark">Credit Card</h3>
                    <div class="card-toolbar">
                        <div class="dropdown dropdown-inline" data-toggle="tooltip" title="Quick actions" data-placement="left">
                            <a href="#" class="btn btn-clean btn-hover-light-primary btn-sm btn-icon" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="ki ki-bold-more-ver"></i>
